...
-- USERS  (AUTO ID)
-- -------------------------
INSERT INTO users (name, email, create_dt)
VALUES ('Alice Adams', 'alice.adams@example.com', '2025-10-01'),
...
-- ACCOUNTS
-- -------------------------
INSERT INTO accounts (user_id, account_number, account_type, branch_address, create_dt)
VALUES (1, 10000001, 'SAVINGS', '123 Main St, Las Vegas, NV', '2025-10-01'),
...
INSERT INTO account_transactions (transaction_id,
                                  ...
                                  closing_balance,
                                  create_dt)
VALUES ('TXN-1001', 10000001, 1, '2025-10-02', 'ATM Withdrawal', 'DEBIT', 200, 4800, '2025-10-02'),
       ...
       ('TXN-1006', 10000001, 1, '2025-10-10', 'Grocery Payment', 'DEBIT', 60, 6240, '2025-10-10'),
       -- Diana Dawson transactions (25 total)
       ...
       ('TXN-2008', 10000005, 4, '2025-09-20', 'Cash Deposit', 'CREDIT', 1000, 7645, '2025-09-20'),
       ('TXN-2009', 10000005, 4, '2025-09-22', 'Restaurant Payment', 'DEBIT', 75, 7570, '2025-09-22'),
       ('TXN-2010', 10000005, 4, '2025-09-25', 'Interest Credit', 'CREDIT', 12, 7582, '2025-09-25'),
       ('TXN-2011', 10000005, 4, '2025-09-28', 'Freelance Income', 'CREDIT', 600, 8182, '2025-09-28'),
       ('TXN-2012', 10000005, 4, '2025-10-01', 'Gas Station', 'DEBIT', 50, 8132, '2025-10-01'),
       ('TXN-2013', 10000005, 4, '2025-10-05', 'Monthly Salary', 'CREDIT', 3500, 11632, '2025-10-05'),
       ('TXN-2014', 10000005, 4, '2025-10-07', 'Rent Payment', 'DEBIT', 1200, 10432, '2025-10-07'),
       ('TXN-2015', 10000005, 4, '2025-10-09', 'Pharmacy Purchase', 'DEBIT', 45, 10387, '2025-10-09'),
       ('TXN-2016', 10000005, 4, '2025-10-11', 'Credit Card Payment', 'DEBIT', 300, 10087, '2025-10-11'),
       ('TXN-2017', 10000005, 4, '2025-10-12', 'Coffee Shop', 'DEBIT', 25, 10062, '2025-10-12'),
       ('TXN-2018', 10000005, 4, '2025-10-15', 'Investment Transfer', 'CREDIT', 2000, 12062, '2025-10-15'),
       ('TXN-2019', 10000005, 4, '2025-10-16', 'Shopping Mall Purchase', 'DEBIT', 180, 11882, '2025-10-16'),
       ('TXN-2020', 10000005, 4, '2025-10-18', 'Restaurant Dinner', 'DEBIT', 90, 11792, '2025-10-18'),
       ('TXN-2021', 10000005, 4, '2025-10-20', 'Emergency Withdrawal', 'DEBIT', 500, 11292, '2025-10-20'),
       ('TXN-2022', 10000005, 4, '2025-10-22', 'Online Subscription', 'DEBIT', 15, 11277, '2025-10-22'),
       ('TXN-2023', 10000005, 4, '2025-10-24', 'Utility Payment', 'DEBIT', 120, 11157, '2025-10-24'),
       ('TXN-2024', 10000005, 4, '2025-10-25', 'Interest Credit', 'CREDIT', 18, 11175, '2025-10-25'),
       ('TXN-2025', 10000005, 4, '2025-10-27', 'Grocery Shopping', 'DEBIT', 165, 11010, '2025-10-27');

-- -------------------------
-- CARDS
-- -------------------------
INSERT INTO cards (card_id, user_id, card_number, card_type, total_limit, amount_used, available_amount, create_dt)
VALUES (5001, 1, '4111111111111111', 'VISA', 5000, 1200, 3800, '2025-10-01'),
       ...
       (5007, 4, '3530111333300000', 'JCB', 10000, 1500, 8500, '2025-08-20'),
...
VALUES ('C-1001', 'Alice Adams', 'alice.adams@example.com', 'Unable to login',
        'I tried resetting my password but still cannot log in.', '2025-10-01'),
       ('C-1002', 'Bob Brown', 'bob.brown@example.com', 'New card request',
        'Please issue a replacement card for my expired one.', '2025-10-02'),
       ('C-1003', 'Charlie Carter', 'charlie.carter@example.com', 'Loan inquiry',
        'Could you provide details about available loan options?', '2025-10-03'),
       ('C-1004', 'Diana Dawson', 'diana.dawson@example.com', 'Account closure',
        'I would like to close my secondary checking account.', '2025-10-04'),
       ('C-1005', 'Ethan Evans', 'ethan.evans@example.com', 'Feedback',
        'The new mobile banking UI is great! Keep it up.', '2025-10-05');

-- -------------------------
-- LOANS  (FIXED: added create_dt col; removed stray comma; MySQL dates)
-- -------------------------
INSERT INTO loans (loan_number,
                   user_id,
                   start_dt,
                   loan_type,
                   total_loan,
                   ...
                   outstanding_amount,
                   create_dt)
VALUES (7001, 1, '2023-06-15', 'HOME', 250000, 50000, 200000, '2025-10-01'),
...
-- NOTICE DETAILS
-- -------------------------
INSERT INTO notice_details (notice_id,
                            notice_summary,
                            notice_details,
                            notic_beg_dt,
                            notic_end_dt,
                            create_dt,
                            update_dt)
VALUES (9001, 'Scheduled Maintenance',
